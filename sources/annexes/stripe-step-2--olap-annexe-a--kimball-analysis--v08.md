...
Six processus métiers sont identifiés, d'après les catégories de données analytiques du cahier des charges \[R0\] (DS2 : *Revenue Metrics*, *Customer Segmentation Data*, *Product Performance Metrics*, *Fraud Analysis Data*, *Compliance and Audit Logs*).
...
`DimReferenceExchangeRate` porte un taux de conversion de référence fixe pour l'année(différent a priori du taux du jour) pour que deux montants convertis à des dates différentes restent comparables entre eux. 
