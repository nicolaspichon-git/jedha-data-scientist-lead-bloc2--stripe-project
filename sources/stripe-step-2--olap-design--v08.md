...
# 2. OLAP Data System
## D3. OLAP System Schema Design

> *Nicolas Pichon - AIA RNCP 38777 / BC02 / D3 : OLAP System Schema Design / v08 - 2026/10/13.*
...
###### Justification
Le flocon (snowflake) réduit la redondance au prix de jointures supplémentaires ; en lecture analytique, c'est l'inverse de l'objectif recherché (TR1 \[R0\]  : *"optimize performance across all systems"*). La dénormalisation assumée dans les dimensions coûte en stockage mais pas en temps de requête.
...
![[stripe-step-2--olap-design--v08--diagram-1.svg]]
...
![[stripe-step-2--olap-design--v08--diagram-2.svg]]
...
![[stripe-step-2--olap-design--v08--diagram-3.svg]]
...
angle d'analyse ; l'agrégat précalculé garde parfois l'attribut en clair (`regulation
...
**`DimDate` précalculée.** Évite les fonctions de date dans les clauses `WHERE`
...
**Stockage orienté colonne.** *Redshift*, *BigQuery*, *Snowflake* ou *ClickHouse* ; cohérent avec des requêtes qui agrègent peu de colonnes sur beaucoup de lignes, l'inverse du pattern OLTP.
